...
// TO RUN THIS DEMO:
/*
 * 0. Change the "stratigility directory
 * 1. Run "composer update" to install stratigility, etc.
 * 2. From this directory run this command: "php -S localhost:9999 -t public"
...
foreach ($order as $key) {
    if (isset($middleware[$key]['path']) && $middleware[$key]['path']) {
